...
# 需要提取的图像列表
IMAGE_LIST_DIR = '/home/shouldchan/文档/CNN_caffe/Toro/Toro_photoID_DESCRIPTION.txt'

IMAGE_DIR = '/home/shouldchan/文档/CNN_caffe/Toro/pic_Toro/'

VECTOR_DIR = '/home/shouldchan/文档/CNN_caffe/Toro/'
...
# 提取特征并保存为相应地文件
def extractFeature(image_list, image_dict, net):
...
if __name__ == "__main__":
    net = initilize()
    image_list, image_dict = readImageList(IMAGE_LIST_DIR) 
    extractFeature(image_list,image_dict, net)
